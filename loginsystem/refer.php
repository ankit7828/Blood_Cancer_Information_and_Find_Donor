...
if (isset($_POST["refer"])) {
    $check = "SELECT * FROM `referdata` WHERE email = '$_POST[email]' and name='$_POST[name]' and phone ='$_POST[phone]' ";
    ...
    if ($result) {
        if (mysqli_num_rows($result) > 0) {
            ...
            $sql = "INSERT INTO `referdata`(`name`, `email`, `phone`, `age`, `address`, `bloodtype`, `rhfactor`, `hla` , `referal`) VALUES ('$name','$email','$phone','$age','$address','$bloodtype','$rhfactor','$hla' , '$referal')";
...
<head>
    ...
    <title>Blood Cancer Treatment | Refer Patient</title>
    <style>
...
<!-- <br><br><br><br><br><br><br> -->
    ...
    <div class="donation">
        <h2 class="title">Refer New Patient</h2>
        <form action="" method="post">
            ...
            <div class="form-group">
                <input type="text" name="referal" placeholder="Enter referal Name" required>
            </div>
            <input type="submit" name="refer" value="Refer Patient">
        </form>
    </div>
