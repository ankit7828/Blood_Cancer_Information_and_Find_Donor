...
include "config.php";
session_start();
$check = "SELECT * FROM `patientdata` WHERE name = '$_SESSION[name]' and email = '$_SESSION[email]' and phone = '$_SESSION[phone]' ";
...
<head>
    ...
    <link rel="stylesheet" href="../css/style.css">
        ...
        <title>Blood Cancer Treatment | Patient Found</title>
        <style>
...
<nav class="navbar">
    ...
    <div class="found donation">
        <h2 class="title">About the Patient</h2>
            <div class="form">
            <div class="form-group1">
                <p style="font-size: 1.3rem;">Patient has found you can contact him by the given data below</p>
            </div>
            <div class="form-group1">
